...
export default function SymbolHeader({ symbolData, showChart, onChartToggle }) {
    ...
    <div className="symbol-header">
      <div className="symbol-header-inner">
        <div className="symbol-header-logo">
          {logo
            ? <div className="symbol-header-logo-card"><img src={logo} alt={company} /></div>
            : <div className="symbol-header-logo-placeholder">{symbol ? symbol.slice(0, 3) : '—'}</div>
          }
        </div>
        <div className="symbol-header-details">
          ...
          <div className="symbol-header-price-block">
            <div className="symbol-header-price-main">
              <span className="symbol-header-price-value">{formatLKRFull(currentPrice ?? 0)}</span>
